...
def ingest_semantic(jsonl_path: str, limit: int = None, batch_size: int = 100):
    import time
    import torch
    ...
    print("Initializing Semantic Baseline RAG Pipeline...")
    ...
    print(f"Successfully ingested {count} documents into Qdrant (semantic_rag collection).")
...
if __name__ == "__main__":
    ...
    ingest_semantic(corpus_path, limit=None)
