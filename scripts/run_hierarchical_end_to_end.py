...
def run_end_to_end():
    ...
    print("Initializing Hierarchical Baseline RAG Pipeline (IN-MEMORY MODE)...")
    start_time = time.time()
    
    # Passing in_memory=True completely bypasses SQLite disk I/O!
    rag = HierarchicalBaselineRAG(in_memory=True)
    ...
    for idx, q in enumerate(questions):
        ...
        # Deduplication logic for 128-token chunks
    ...
    out_file = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'hierarchical_eval_results.json'))
