...
class SelfQueryParser:
    ...
    def parse_query(self, query: str) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "If the user mentions 'slack' or 'channel', output {\"source\": \"slack\"}. "
            ...
            "If they mention 'confluence', 'page', 'wiki' or 'space', output {\"source\": \"confluence\"}. "
            "If they mention 'repo', 'pr', 'pull request' or 'github', output {\"source\": \"github\"}. "
            "If they mention 'account', 'customer', 'opportunity' or 'hubspot', output {\"source\": \"hubspot\"}. "
